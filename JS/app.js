...
function skillha1(){
    let newskill = document.getElementById("skillha1")
    let lastskill =document.getElementById("noteskill1")
...
function skillha2(){
    let newskill = document.getElementById("skillha2")
    let lastskill =document.getElementById("noteskill2")
    newskill.style.display = "flex" ;
    lastskill.style.display = "none" ;
}
...
function skillha3(){
    let newskill = document.getElementById("skillha3")
    let lastskill =document.getElementById("noteskill3")
    newskill.style.display = "flex" ;
    lastskill.style.display = "none" ;
}